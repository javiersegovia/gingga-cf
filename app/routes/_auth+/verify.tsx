...
import type { VerificationTypes } from '@/core/auth/auth-schema'
...
import { validateRequest } from '@/core/auth/verification.server'

export async function action({ request, context }: ActionFunctionArgs) {
  const formData = await request.formData()
  checkHoneypot(formData)
  return await validateRequest(request, context, formData)
}
